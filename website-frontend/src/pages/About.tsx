        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="border-l-4 border-zooft-primary">
              <CardHeader>
                <CardTitle className="text-2xl text-zooft-primary">Our Mission</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-l-4 border-zooft-secondary">
              <CardHeader>
                <CardTitle className="text-2xl text-zooft-secondary">Our Vision</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-gray-700 leading-relaxed">
                  {companyInfo.vision}
              ...
              <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-16 h-16 rounded-full bg-zooft-light mx-auto mb-4 flex items-center justify-center">
                    <span className="text-2xl font-bold text-zooft-primary">{index + 1}</span>
                  </div>
                  <CardTitle className="text-xl text-zooft-primary">{value}</CardTitle>
                </CardHeader>
              </Card>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-zooft-primary mb-2">5+</div>
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-zooft-primary mb-2">30+</div>
              <div className="text-gray-600">Happy Clients</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-zooft-primary mb-2">10+</div>
                  ...
                  <div className="w-32 h-32 rounded-full bg-gray-200 mx-auto mb-4 overflow-hidden">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        target.src = 'https://via.placeholder.com/128x128/6366f1/ffffff?text=' + member.name.charAt(0);
                      }}
                    />
                  </div>
                  <CardTitle className="text-xl text-zooft-primary">{member.name}</CardTitle>
