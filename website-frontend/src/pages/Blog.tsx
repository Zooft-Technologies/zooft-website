...
const BlogPage: React.FC = () => {
  const categories = ['all', 'technology', 'business', 'innovation', 'cybersecurity'];
                ...
                <div className="aspect-video bg-gray-200 rounded-t-lg overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://via.placeholder.com/400x225/6366f1/ffffff?text=Blog';
                    }}
                  />
                </div>
            ...
            {[
              {
                ...
                posts: 15,
                description: 'How businesses can leverage technology for growth',
                icon: '🚀'
              },
              {
                topic: 'Cybersecurity',
              ...
              },
              {
                ...
                posts: 25,
                description: 'Best practices and emerging technologies',
                icon: '💻'
              }
            ].map((topic, index) => (
