    ...
    try {
      ...
      if (result.success) {
        ...
        setFormState(prev => ({
          ...prev,
          isSubmitting: false,
          errors: [{ field: 'general', message: result.error || 'Failed to send message' }]
        }));
      }
    } catch (error) {
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                ...
                <a
                  ...
                  className="text-zooft-primary font-medium hover:text-zooft-dark"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-zooft-primary"
                    >
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={handleInputChange}
                      className={`min-h-[120px] ${getFieldError('message') ? 'border-red-500' : ''}`}
                  ...
                  <Button
                    ...
                    className="w-full bg-zooft-primary hover:bg-zooft-dark text-white py-3"
                  >
                ...
                <CardContent>
                  <div className="flex space-x-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-full bg-zooft-light flex items-center justify-center text-zooft-primary hover:bg-zooft-primary hover:text-white transition-colors"
                    >
                      🐦
                    </a>
                    <a
