      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-zooft-primary to-zooft-dark text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
            Showcasing successful technology solutions we've delivered for our clients
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              <Card key={project.id} className="hover:shadow-xl transition-shadow duration-300">
                <div className="aspect-video bg-gray-200 rounded-t-lg overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://via.placeholder.com/400x225/6366f1/ffffff?text=' + project.title.charAt(0);
                    }}
                  />
                </div>
                ...
                <CardContent>
                  <div className="mb-4">
                    <h4 className="font-semibold text-zooft-primary mb-2">Technologies Used</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                category: 'Healthcare',
                count: 8,
                description: 'Medical management and patient systems',
                icon: '🏥'
              },
              {
                category: 'Finance',
              ...
              },
              {
                category: 'Education',
                count: 10,
                description: 'Learning management and academic systems',
                icon: '📚'
              }
            ].map((category, index) => (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-zooft-primary mb-2">98%</div>
              <div className="text-gray-600">Client Satisfaction</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-zooft-primary mb-2">100%</div>
              <div className="text-gray-600">On-Time Delivery</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-zooft-primary mb-2">24/7</div>
              <div className="text-gray-600">Support Available</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-zooft-primary mb-2">50+</div>
      ...
      <section className="py-16 md:py-24 bg-zooft-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Ready to join our list of successful clients? Let's discuss your project requirements.
          </p>
          <Link
            to="/contact"
