              ...
              <Card key={service.id} className="hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-zooft-primary mb-3">Features</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-zooft-primary mb-3">Benefits</h4>
                      <ul className="space-y-2">
            ...
            {[
              ...
              >
                <div className="w-16 h-16 bg-gray-100 rounded-lg mx-auto mb-3 flex items-center justify-center">
                  <span className="text-zooft-primary font-bold">{tech.charAt(0)}</span>
                </div>
